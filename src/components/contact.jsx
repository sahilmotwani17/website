    ...
    return (
      <div id="contact">
        ...
        <span className='cinfo' style={{marginLeft: '2.8vw'}}> 
            ...
            <a href='mailto:dimplemotwani811@gmail.com'style={{marginLeft:'0.8vw', color:'black',fontFamily: 'Proxima Nova', fontSize: '1vw', fontWeight: 400, letterSpacing: '0em', textAlign: 'left'}}>dimplemotwani811@gmail.com</a>
        </span>
        <span  className='cinfo' style={{marginLeft: '2.8vw'}}> 
